      ...
      <div className='flex-col flex'>
        <div className='p-8 flex justify-center'>
          <div className='w-[1280px]'>
            <p className='pb-8 text-4xl'>{t('about.characters')}</p>
            <div className='flex items-center'>
              <div>
                <p className='text-3xl'><b>灰妲 DaDa</b></p>
                <p className='text-lg underline'><a href='https://relive-project0.com/portfolio/dada/'>ReLive Project {t('about.gen1')}</a></p>
              ...
              <div>
                ...
                <p className='text-lg underline'><a href='https://relive-project0.com/portfolio/meemu/'>ReLive Project {t('about.gen2')}</a></p>
                <div className='mt-4 space-x-4'>
        ...
        <div className='flex-1 p-8 flex justify-center'>
          <div>
            <p className='pb-8 text-4xl'>{t('about.motivation')}</p>
