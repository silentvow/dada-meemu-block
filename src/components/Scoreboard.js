...
function Scoreboard () {
  ...
  return (
    <Container width={1280} height={960}>
      ...
      <ScoreCard x={40 + 16} y={20 + 16} title='故事模式' records={records[0]} mode={GAME_MODE.STORY} />
      {/* <ScoreCard x={40 + 16} y={20 + 16} title='故事模式' records={records[1]} mode={GAME_MODE.EXTRA_STORY} /> */}
