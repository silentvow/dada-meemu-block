...
export const FPS_LIMIT_PREV = {
  [FPS_LIMIT.NO_LIMIT]: FPS_LIMIT.EXTRA_HIGH,
  [FPS_LIMIT.EXTRA_HIGH]: FPS_LIMIT.VERY_HIGH,
  [FPS_LIMIT.VERY_HIGH]: FPS_LIMIT.HIGH,
  [FPS_LIMIT.HIGH]: FPS_LIMIT.MEDIUM,
  [FPS_LIMIT.MEDIUM]: FPS_LIMIT.LOW,
  [FPS_LIMIT.LOW]: FPS_LIMIT.VERY_LOW,
  [FPS_LIMIT.VERY_LOW]: FPS_LIMIT.VERY_LOW,
}

export const FPS_LIMIT_NEXT = {
  [FPS_LIMIT.NO_LIMIT]: FPS_LIMIT.NO_LIMIT,
  [FPS_LIMIT.EXTRA_HIGH]: FPS_LIMIT.NO_LIMIT,
  [FPS_LIMIT.VERY_HIGH]: FPS_LIMIT.EXTRA_HIGH,
  [FPS_LIMIT.HIGH]: FPS_LIMIT.VERY_HIGH,
  [FPS_LIMIT.MEDIUM]: FPS_LIMIT.HIGH,
  [FPS_LIMIT.LOW]: FPS_LIMIT.MEDIUM,
  [FPS_LIMIT.VERY_LOW]: FPS_LIMIT.LOW,
}

export const FPS_LIMIT_VALUE = {
  [FPS_LIMIT.NO_LIMIT]: 0,
  [FPS_LIMIT.EXTRA_HIGH]: 144,
  [FPS_LIMIT.VERY_HIGH]: 120,
  [FPS_LIMIT.HIGH]: 100,
  [FPS_LIMIT.MEDIUM]: 80,
  [FPS_LIMIT.LOW]: 60,
  [FPS_LIMIT.VERY_LOW]: 30,
}
